 ...
 * @DateTime 5 Oct 2019 1:56:04 pm
 */
@Configuration
@EnableTransactionManagement
@EnableJpaRepositories(basePackages = { "com.aia.print.agent.repository" })
public class PersistenceJPAConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[] { "com.aia.print.agent.entiry" });
