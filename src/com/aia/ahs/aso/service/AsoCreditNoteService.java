...
public class AsoCreditNoteService implements TemplateActions {
    ...
    public int genReport(CompanyCode companyCode, BatchCycle batchCycle, BatchFileDetails batchFileDetails) {
        ...
        HashMap< Integer , HashMap< Integer , HashMap< String , Object > > > asoCreditNoteRSDetails =
            getAsoCreditNoteDetails(batchFileDetails.getFileLocation());
        ...
        for (int i = 0; i < noFiles; i++) {
            ...
            this.uploadReport(dataSource, companyCode.getCompanyCode());
    ...
    public synchronized void uploadReport(HashMap< String , Object > dataSource, String companyCode) {
        ...
        try {
            ...
            if (companyCode.equalsIgnoreCase("Co3")) {
                this.companyCode = 3;
                jrFullReadpath = this.jasper + "PrintingAgentReports\\AHS\\conventional\\ASO\\AsoCreditNote.jasper";
                String billmonth = "" + dataSource.get("billMonth");
                String billperiod = billmonth.replace("/", "");
                pdfname = dataSource.get("policyNum") + "_" + billperiod + "_" + dataSource.get("billNum") + "_ASOCN.pdf";
    ...
    public HashMap< Integer , HashMap< Integer , HashMap< String , Object > > > getAsoCreditNoteDetails(String filepath) {
        ...
        HashMap< Integer , HashMap< Integer , HashMap< String , Object > > > asoCreditNotetRSDetails =
            ...
            if (br == null || br.equals("")) {
                ...
                while ((sCurrentLine = br.readLine()) != null) {
                    ...
                    if (data[0].equalsIgnoreCase("0001") && data[1].equalsIgnoreCase("1H")) {
                        ...
                        asoCreditNote.put("addressLine1", data[3] != null && data[3].length() > 0 ? data[3].trim() : "");
                        asoCreditNote.put("addressLine2", data[4] != null && data[4].length() > 0 ? data[4].trim() : "");
                        asoCreditNote.put("addressLine3", data[5] != null && data[5].length() > 0 ? data[5].trim() : "");
                        asoCreditNote.put("addressLine4", data[6] != null && data[6].length() > 0 ? data[6].trim() : "");
                        asoCreditNote.put("addressLine5", data[7] != null && data[7].length() > 0 ? data[7].trim() : "");
                        ...
                        asoCreditNote.put("billMonth", data[10] != null && data[10].length() > 0 ? data[10].trim() : "");
                        asoCreditNote.put("paymentDueDate", data[11] != null && data[11].length() > 0 ? data[11].trim() : "");
                        asoCreditNote.put("authorisedPerson", data[12] != null && data[12].length() > 0 ? data[12].trim() : "");
                        asoCreditNote.put("phoneNum", data[13] != null && data[13].length() > 0 ? data[13].trim() : "");
                        asoCreditNote.put("portalUploadStatus", data[14] != null && data[14].length() > 0 ? data[14].trim() : "");
                        if (data.length >= 16) {
                            asoCreditNote.put("printHardCp", data[15] != null && data[15].length() > 0 ? data[15].trim() : "");
                        }
                        if (data.length >= 17) {
                            asoCreditNote.put("policyType", data[16] != null && data[16].length() > 0 ? data[16].trim() : "");
                        }
                        if (data.length >= 18) {
                            asoCreditNote.put("policyTypeDscr", data[17] != null && data[17].length() > 0 ? data[17].trim() : "");
                        }
                        if (data.length >= 19) {
                            asoCreditNote.put("bankAcNo", data[18] != null && data[18].length() > 0 ? data[18].trim() : "");
                        }
                        if (data.length >= 20) {
                            asoCreditNote.put("bankName", data[19] != null && data[19].length() > 0 ? data[19].trim() : "");
                        }

                    }
                    if (data[0].equalsIgnoreCase("0001") && data[1].equalsIgnoreCase("2H")) {
                        asoCreditNote.put("policyHolder", data[2] != null && data[2].length() > 0 ? data[2].trim() : "");

                        asoCreditNote.put("policyHolderNum", data[3] != null && data[3].length() > 0 ? data[3].trim() : "");

                        asoCreditNote.put("subsidiary", data[4] != null && data[4].length() > 0 ? data[4].trim() : "");

                        if (data.length >= 6) {
                            asoCreditNote.put("subsidiaryNum", data[5] != null && data[5].length() > 0 ? data[5].trim() : "");
                        }
                        if (data.length >= 7) {
                            asoCreditNote.put("policyNum", data[6] != null && data[6].length() > 0 ? data[6].trim() : "");
                        }
    ...
    public static void main(String[] args) {
        ...
        batchFileDetails.setFileLocation("D:\\PrintAgenttext\\company3\\20190701\\Co3_ASOCN_ ASO Credit Note_20190701_0079.txt");

        BatchCycle batchCycle = new BatchCycle();
        batchCycle.setCycleDate("20190701");

        AsoCreditNoteService a = new AsoCreditNoteService();
        // String filepath = "D:\\PrintAgenttext\\company3\\20190701\\Co3_ASOCN_ ASO Credit Note_20190701_0079.txt";
